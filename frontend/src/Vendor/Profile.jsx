...
const Profile = () => {
  ...
  function handleSubmit() {
    PerformRequest("/api/profile", "PUT", profile).then((data) => {
      console.log(data);
    });
  }
        ...
        <div className=" w-full flex justify-center">
          <div className="w-full bg-white max-w-2xl border border-green-300 shadow overflow-hidden sm:rounded-lg p-4">
            ...
            {profile.services.map((elem, key) => {
              return (
                <span className="bg-green-100 text-green-800 text-xs font-medium me-2 pl-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                  {elem}
                  <button
                    className="ml-2 border border-green-600 text-xsm rounded-full px-1"
